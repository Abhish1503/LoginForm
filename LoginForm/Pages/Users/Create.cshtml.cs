...
namespace LoginForm.Pages.Users
{
    public class CreateModel : PageModel
    {
		...
		public void OnPost()
		{
			...
			if(userInfo.firstName.Length ==0 || userInfo.email.Length ==0 || userInfo.lastName.Length ==0 || userInfo.userName.Length ==0 || userInfo.password.Length == 0 || userInfo.address.Length == 0)
			{
